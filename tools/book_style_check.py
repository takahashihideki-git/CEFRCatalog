...
# 既知の未解消事項（検出済み・裁定待ち。解消したらここから消す ── restore.py の KNOWN_ISSUES 方式）
# カタログ16検出: B1範型幕間は素材10件中 618/698 を本文未使用（範型はカタログ13作、全素材使用の達成はカタログ15以降）。
# 織り込むか、全使用を努力目標へ格下げするかは §7 申し送りの裁定待ち。
KNOWN_GAPS = {'範型幕間_B1という人.md': {618, 698}}
