...
- `catalog_*.json`: 全数シート（意見31行＝口頭23＋書面8／苦情9行＝口頭5＋書面4）。全行の原文・レベル・訳・行為所属・**全数性**（行集合＝インベントリの行為所属集合）を照合、DISCUSSION 5段落
