...
(645, '書面', ["Do you want to come to my birthday party on Saturday?", "Sorry, I can't come on Friday. How about Sunday?"],
 ...
 "書面2行の下端（上は697・B2、あいだに段はない）。誘い・調整が文字で完結する最小形。"),
...
(467, '口頭', ["The bus is cheaper, but the train is faster.", "Saturday is better for me, but Sunday works for everyone."],
 "何をするか・どこへ行くか・誰を／どれを選ぶかを話し合いながら、選択肢を比較・対照する。",
 "比較の談話型（A is X, but B is Y）：選択肢を対で陳列する。",
