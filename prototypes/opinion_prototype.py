...
ROWS = [
 ...
 # 書面・オンライン系列
 ("書面","A2",683,
  "Can make brief positive or negative comments online about embedded links and media using a repertoire of basic language.",
  "埋め込みリンクやメディアに、基本的な言葉で短い肯定・否定コメントをオンラインでできる。",
 ...
 ("書面","B1",677,
  "Can post a comprehensible contribution in an online discussion on a familiar topic of interest, provided they can prepare the text beforehand.",
  "事前に準備できれば、関心のある身近な話題のオンライン議論に理解可能な投稿ができる。",
