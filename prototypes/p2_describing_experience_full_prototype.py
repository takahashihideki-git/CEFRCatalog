...
- (b) 篩なし／ジャンル×談話課題の二層／構築梯子型（第5梯子型）
...
def build(root="."):
    ...
    sheet = {
        ...
        "type": "第2柱（産出・談話構築）。梯子型＝構築梯子型（第5型。仮設＝CEFRカタログ7、本採用＝判断(ab)・CEFRカタログ8）。談話課題糸＝自己提示／静的描写／語り／感情・評価／統合（作業層）",
